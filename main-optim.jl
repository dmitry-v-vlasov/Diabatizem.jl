...
oam = findOptimizableCouplings(∂_∂Rᴬ, ∂_∂Rᵈᵃᵗᵃ, Aˡᶻᶠ, Sl, C.settings.nonadiabatic_areas);
@info "$oam"
∂_∂Rᵐᵒᵈᵉˡ² = optimizeCouplings(oam, ∂_∂Rᴬ, ∂_∂Rᵐᵒᵈᵉˡ);

@info "SECOND ITERATION Solutions and their expanding..."
Sl2 = solverTransformationMatrixForAreas(Aˡᶻᶠˡ, ∂_∂Rᴬ, ∂_∂Rᵐᵒᵈᵉˡ², Rᵈᵃᵗᵃ, C.settings.diabatization);
expandLocalSolutions(Sl2, Rᵈᵃᵗᵃ, C.settings.diabatization);
@info "... Done."

∂_∂R_model_2_l = matf2matl(Rᵈᵃᵗᵃ, ∂_∂Rᵐᵒᵈᵉˡ²);
∂_∂R_model_data_2 = matl2matupper_data(Rᵈᵃᵗᵃ, ∂_∂R_model_2_l)
∂_∂R_model_dataframe_2 = DataFrame(∂_∂R_model_data_2)
saveMatrixElementTable(∂_∂R_model_dataframe_2, "../../output/ddr_II.csv")
∂_∂R_A_l = matf2matl(Rᵈᵃᵗᵃ, ∂_∂Rᴬ);
∂_∂R_A_data = matl2matupper_data(Rᵈᵃᵗᵃ, ∂_∂R_A_l)
∂_∂R_A_dataframe = DataFrame(∂_∂R_A_data)
saveMatrixElementTable(∂_∂R_A_dataframe, "../../output/ddr_A.csv")

@info "Diabatizing..."
Rᶜ, S, Hᴰ, ∂_∂Rᴰ, ∂_∂Rᵐ = diabatize(
    Hᴬ, ∂_∂Rᴬ, ∂_∂Rᵐᵒᵈᵉˡ², Rᵈᵃᵗᵃ,
    oam,
    Sl2, C.settings.diabatization, Aˡᶻᶠ);
@info "... Done."
